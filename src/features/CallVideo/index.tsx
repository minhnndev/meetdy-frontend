...
function CallVideo() {
    ...
    const handleToggleVideo = () => {
        ...
        if (isEnabled) myStreamRef.current.srcObject.getVideoTracks()[0].enabled = false;
    ...
    const handleToggleAudio = () => {
        ...
        if (isEnabled) myStreamRef.current.srcObject.getAudioTracks()[0].enabled = false;
    ...
    const handleShareScreen = () => {
        navigator.mediaDevices.getDisplayMedia({ video: true }).then((stream) => {
            ...
            let sender = remotePeerRef.current.peerConnection.getSenders().find(function (s) {
