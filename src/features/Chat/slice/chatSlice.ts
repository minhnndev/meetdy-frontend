...
export const fetchListConversations = createAsyncThunk(
    ...
    async (params, thunkApi) => {
        ...
        const conversations = await conversationApi.fetchListConversations(name, type);
...
export const fetchListMessages = createAsyncThunk(
    ...
    async (params, thunkApi) => {
        ...
        const messages = await messageApi.fetchListMessages(conversationId, page, size);
...
export const fetchNextPageMessageOfChannel = createAsyncThunk(
    ...
    async (params, thunkApi) => {
        ...
        const messages = await channelApi.fetchMessageInChannel(channelId, page, size);
        return messages;
    }
);
...
// Create a group chat
export const createGroup = createAsyncThunk(`${KEY}/createGroup`, async (params, thunkApi) => {
...
export const fetchConversationById = createAsyncThunk(
    ...
    async (params, thunkApi) => {
        ...
        const conversation = await conversationApi.fetchConversationById(conversationId);
...
export const getMembersConversation = createAsyncThunk(
    ...
    async (params, thunkApi) => {
        const { conversationId } = params;
        const members = await conversationApi.fetchMemberInConversation(conversationId);
        return members;
    }
);
...
export const fetchPinMessages = createAsyncThunk(`${KEY}/fetchPinMessages`, async (params, _) => {
    const { conversationId } = params;
    const pinMessages = await pinMessageApi.fetchPinMessages(conversationId);
    return pinMessages;
});
...
export const getLastViewOfMembers = createAsyncThunk(
    ...
    async (params, _) => {
        const { conversationId } = params;
        const lastViews = await conversationApi.getLastViewOfMembers(conversationId);
...
export const fetchChannels = createAsyncThunk(`${KEY}/fetchChannels`, async (params, _) => {
    const { conversationId } = params;
...
export const fetchMessageInChannel = createAsyncThunk(
    ...
    async (params, _) => {
        ...
        const data = await channelApi.fetchMessageInChannel(channelId, page, size);
...
export const fetchAllSticker = createAsyncThunk(`${KEY}/fetchAllSticker`, async () => {
    const data = await stickerApi.fetchAllSticker();
    return data;
});

export const fetchVotes = createAsyncThunk(`${KEY}/fetchVotes`, async (params, _) => {
    const { conversationId, page, size } = params;
    const data = await voteApi.fetchVotes(conversationId, page, size);
    return data;
});
...
const chatSlice = createSlice({
    ...
    reducers: {
        ...
        addMessageInChannel: (state, action) => {
            ...
            const channelTemps = state.channels.filter((channel) => channel._id !== channelId);
        ...
        updateVoteMessage: (state, action) => {
            ...
            const index = state.messages.findIndex((ele) => ele._id === voteMessage._id);
