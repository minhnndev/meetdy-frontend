...
import ModalViewOption from "@/components/legacy/ModalViewOption";
        ...
        <div className="vote-message-wrapper">
            <div className="vote-message">
                ...
                {getNumberJoinVote().length > 0 && (
                    <span onClick={handleDetailVote} className="vote-message_number-voted">
                        Đã có {checkNumberUserSelected()} lượt bình chọn <CaretRightOutlined />
                    </span>
                )}
                ...
                <div className="vote-message_view-all">
                    <Button onClick={handleViewOption} type="primary" style={{ width: "100%" }}>
                        Xem lựa chọn
                    </Button>
                </div>
            </div>
