...
import UploadFile from "@/utils/customfield/upLoadFile";
    ...
    return (
        <div style={isFocus ? styleBorder : {}} id="navigation-chat-box">
            <ul>
                <Popover
                    content={
                        <Sticker onClose={handleOnClose} data={stickers} onScroll={onScroll} />
                    }
                    trigger="click"
                    visible={visiblePop}
            ...
            <ModalCreateVote visible={isVisibleVote} onCancel={handleCloseModalVote} />
        </div>
    );
}
