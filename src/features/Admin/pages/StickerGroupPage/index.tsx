...
function StickerGroupPage(props) {
        ...
        },
        {
            ...
            render: (data, row) => (
                <Space size="middle">
                    ...
                    <a alt="xem sticker" onClick={() => handleViewSticker(data._id, data.stickers)}>
                        <EyeTwoTone />
                        Xem Sticker{" "}
                    </a>
                </Space>
    ...
    const handleCreatGroupSticker = async (values) => {
        ...
        try {
            const groupSticker = await adminApi.createGroupSticker(name, description);
    ...
    return (
        <div style={{ padding: "10px 20px" }}>
            ...
            >
                <Form layout="vertical" onFinish={handleCreatGroupSticker} hideRequiredMark>
                    <Row gutter={16}>
                        <Col span={12}>
                            <Form.Item
                                name="name"
