...
const chatBubbleMessageVariants = cva("p-2", {
    variants: {
        variant: {
            received: "bg-chat-secondary text-chat-secondary-foreground rounded-r-lg rounded-tl-lg",
            sent: "bg-chat-primary text-chat-primary-foreground rounded-l-lg rounded-tr-lg",
        },
        layout: {
            default: "",
