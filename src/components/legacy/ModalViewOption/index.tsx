...
import { equalsArray } from "@/utils/utilsLegacy/arrayHelper";
import "./style.css";
    ...
    const footer = (
        <div className="footer_wrapper">
            <div className="footer_right-btn">
                ...
                <Button type="primary" onClick={handleOk} icon={<Spin spinning={confirmLoading} />}>
                    Xác nhận
                </Button>
            </div>
        </div>
            ...
            <div className="modal-view-option">
                ...
                {(getMumberVotes() && getMumberVotes()) > 0 && (
                    <p className="overview-text" onClick={handleShowDetail}>
                        {`${getNumberJoinVote().length} người tham gia ${getMumberVotes()} lượt bình chọn `}
                        <CaretRightOutlined />
                    </p>
                )}
                                                    ...
                                                    if (getUserFromConver(ele)) {
                                                        return (
                                                            <PersonalIcon
                                                                ...
                                                                avatar={
                                                                    getUserFromConver(ele)?.avatar
                                                                }
                                                                demention={32}
                                                                color={
                                                                    getUserFromConver(ele)
                                                                        ?.avatarColor
                                                                }
                                                            />
                                                        );
