...
function UserCard(props) {
    ...
    function confirm() {
        Modal.confirm({
            ...
            content: (
                <span>
                    Bạn có thực sự muốn xóa <strong>{user.name}</strong> khỏi danh sách bạn bè{" "}
                </span>
            ),
            okText: "Xóa",
            cancelText: "Hủy",
            ...
            <div id="user-card">
                <div className="user-card_wrapper">
                    ...
                    <div className="user-card-button">
                        ...
                        <div
                            className={`user-card-button--message ${status === "FRIEND" ? "user-card-button--no-margin" : ""}`}
                        >
                            <Button
                    ...
                    <div
                        className={`user-card-button-optional ${!(status === "FRIEND") ? "user-card-button-optional--hidden" : ""}`}
                    >
                        <Button
                            danger
