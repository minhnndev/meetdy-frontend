...
import { IconDelete, IconEdit, IconPlus, IconPriceTag } from "@douyinfe/semi-icons";
import { Button, Modal, Toast, Typography } from "@douyinfe/semi-ui";

const ListClassifyModal = ({ visible, onCancel, openAddModal, openEditModal }) => {
    ...
    return (
        <Modal title="Quản lý thẻ phân loại" visible={visible} onCancel={onCancel} footer={null}>
            {classifies.map((classify: TClassify) => (
                ...
                >
                    <div>
                        <IconPriceTag style={{ color: classify.color.code, marginRight: 4 }} />
