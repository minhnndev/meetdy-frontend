...
const ChatHeaderContent = ({
    ...
    const { currentChannel, channels, currentConversation } = useAppSelector((state) => state.chat);
    ...
    return (
        <>
            <div style={{ display: "flex", alignItems: "center" }}>
                <ConversationAvatar conversation={conversationDetail} totalMembers={totalMembers} />
                <div style={{ paddingLeft: "0.75rem" }}>
                    <Title heading={5} style={{ width: 300 }} ellipsis={{ showTooltip: false }}>
                        {name}
                    </Title>
                    {currentChannel ? (
