...
import { IconExit, IconKeyStroked, IconMore, IconPriceTag } from "@douyinfe/semi-icons";
import { Button, Card, Dropdown, Modal, Popover, Toast, Typography } from "@douyinfe/semi-ui";
...
const GroupCard = ({ group }: { group: TGroupConversation }) => {
    ...
    const onDeleteGroup = () => {
        Modal.warning({
            ...
            content: "Toàn bộ nội dung cuộc trò chuyện sẻ bị xóa, bạn có chắc chắn muốn xóa?",
                    ...
                    render={
                        <Dropdown.Menu>
                            <Popover
                                ...
                                position="rightTop"
                            >
                                <Dropdown.Item icon={<IconPriceTag />}>Thẻ phân loại</Dropdown.Item>
                            </Popover>
                            {leaderId === user._id ? (
                                <Dropdown.Item
                                    icon={<IconExit />}
