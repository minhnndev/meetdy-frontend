...
export const fetchListGroup = createAsyncThunk(`${KEY}/fetchListGroup`, async (param, thunkApi) => {
    const { name, type } = param;
    const data = await conversationApi.fetchListConversations(name, type);
    return data;
});

export const fetchPhoneBook = createAsyncThunk(`${KEY}/fetchPhoneBook`, async (param, thunkApi) => {
