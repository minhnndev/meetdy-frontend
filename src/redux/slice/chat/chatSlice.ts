...
import { TCreateGroup, TGetListConversations } from "@/models/conversation.model";

const KEY = "chat";

// Classify
export const fetchListColor = createAsyncThunk(`${KEY}/fetchListColor`, async () => {
    const colors = await ServiceClassify.getColors();
    return colors;
});

export const fetchListClassify = createAsyncThunk(`${KEY}/fetchListClassify`, async () => {
...
export const fetchNextPageMessageOfChannel = createAsyncThunk(
    ...
    async (params: any) => {
        ...
        const messages = await channelApi.getMessageInChannel(channelId, page, size);
        return messages;
    }
);
...
export const fetchListFriends = createAsyncThunk(`${KEY}/fetchListFriends`, async (params: any) => {
    const { name } = params;
...
// Create a group chat
export const createGroup = createAsyncThunk(`${KEY}/createGroup`, async (params: TCreateGroup) => {
...
export const fetchPinMessages = createAsyncThunk(`${KEY}/fetchPinMessages`, async (params: any) => {
    const { conversationId } = params;
...
export const fetchVotes = createAsyncThunk(`${KEY}/fetchVotes`, async (params: any) => {
    const { conversationId, page, size } = params;
