import { TFetchFriends, TFriend, TRequestFriend, TSuggestFriend } from "@/models/friend.model";
...
const FriendService = {
    ...
    deleteFriend: (userId: string) => axiosClient.delete(`${API.FRIEND.DELETE}/${userId}`),
    ...
    sendRequestFriend: (userId: string) => axiosClient.post(`${API.FRIEND.SEND_REQUEST}/${userId}`),
