...
const ServiceAuth = {
    login: (params: TLogin) => axiosClient.post<any, TLoginResponse>(API.AUTH.LOGIN, params),
    ...
    confirmAccount: (params: TConfirmAccount) => axiosClient.post(API.AUTH.CONFIRM_ACCOUNT, params),
